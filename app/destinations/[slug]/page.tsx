    ...
    <article className="bg-(--background) text-foreground">
      <header className="relative h-[70vh] overflow-hidden">
        ...
        <div className="absolute bottom-10 left-0 right-0 mx-auto max-w-7xl px-6 md:px-10">
          ...
          <h1 className="mt-3 max-w-3xl font-(--font-playfair) text-5xl md:text-7xl">{destination.city}</h1>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.3fr_1fr] md:px-10">
        <div>
          <h2 className="font-(--font-playfair) text-4xl">Travel Overview</h2>
          ...
          <ul className="mt-4 space-y-4">
            {destination.timeline.map((step) => (
              <li key={step.day} className="rounded-xl border border-(--border-soft) bg-white p-4">
          ...
          <ul className="mt-4 space-y-3">
            {faqs.slice(0, 5).map((faq) => (
              <li key={faq.id} className="rounded-xl border border-(--border-soft) bg-white p-4">
        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-(--border-soft) bg-white p-6">
            ...
            <Link href="/booking" className="mt-5 inline-flex text-sm uppercase tracking-[0.2em] text-(--accent-sunset)">
              Start booking
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
        <h2 className="font-(--font-playfair) text-4xl">Related destinations</h2>
