  ...
  return (
    <section className="bg-(--surface) px-6 py-16 text-foreground md:px-10">
      <div className="mx-auto max-w-5xl">
        <h1 className="font-(--font-playfair) text-5xl md:text-7xl">Book Consultation</h1>
        <p className="mt-4 text-zinc-600">Frontend booking flow for luxury itinerary planning.</p>

        <ol className="mt-8 grid gap-3 rounded-2xl border border-(--border-soft) bg-white p-6 text-sm text-zinc-700 md:grid-cols-4">
          {flow.map((step, index) => (
            <li key={step}>
              {index + 1}. {step}
            </li>
